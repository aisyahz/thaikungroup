  ...
  return (
    <section className="relative w-full h-[78vh] md:h-[60vh] lg:h-[80vh] overflow-hidden group">
      ...
      >
        ...
        <div className="hidden md:block absolute inset-0 bg-gradient-to-r from-black via-transparent to-transparent z-[2]" />
      </motion.div>
      ...
      <div className="relative z-10 w-full h-full max-w-7xl mx-auto px-6 flex items-start md:items-center pt-24 md:pt-0">
        <div className="max-w-2xl text-center md:text-left mx-auto md:mx-0">
          <motion.h2 
            ...
            className="hidden md:block text-3xl md:text-5xl lg:text-6xl font-serif text-white tracking-tight mb-6 leading-tight"
          >
          ...
          <motion.p 
            ...
            className="hidden md:block text-white/80 text-base md:text-lg font-light tracking-wide mb-10 leading-relaxed"
          >
            {lang === 'BM' 
          ...
          {/* Mobile Scroll Indicator - Lowered and just arrow */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1, duration: 1 }}
            className="md:hidden absolute bottom-6 left-1/2 -translate-x-1/2 cursor-pointer"
            onClick={() => document.getElementById('scents')?.scrollIntoView({ behavior: 'smooth' })}
          >
            <motion.div
              animate={{ y: [0, 10, 0] }}
