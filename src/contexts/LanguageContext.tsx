...
const translations = {
  BM: {
    ...
    testi_2_name: 'Rogayah Din',
    testi_2_role: 'Perfume Collector',
  ...
  EN: {
    ...
    hero_badge: 'Couture Fragrance',
    hero_title_1: 'Curating',
    hero_title_2: 'Atmosphere.',
